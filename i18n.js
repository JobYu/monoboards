...
'zh-TW': {
  ...
  mdProgress: '進度：',
  mdNoTodos: '尚無待辦事項',
  mdArchivedSection: '已歸檔專案',
  archiveProject: '歸檔',
  unarchiveProject: '取消歸檔',
  archiveTitle: '歸檔',
  archiveEmpty: '尚無已歸檔專案。',
  backToBoard: '返回看板',
  openArchive: '開啟歸檔',
  closeArchive: '返回看板',
  toastArchived: '已歸檔',
  toastUnarchived: '已取消歸檔',
  privacy: '隱私協議',
  terms: '使用協議',
  dateLocale: 'zh-TW'
},
'zh-CN': {
  ...
  mdProgress: '进度：',
  mdNoTodos: '暂无待办事项',
  mdArchivedSection: '已归档项目',
  archiveProject: '归档',
  unarchiveProject: '取消归档',
  archiveTitle: '归档',
  archiveEmpty: '暂无已归档项目。',
  backToBoard: '返回看板',
  openArchive: '打开归档',
  closeArchive: '返回看板',
  toastArchived: '已归档',
...
'en': {
  ...
  deleteTodo: 'Delete',
  todoMoreSub: 'Sub-tasks…',
  todoMoreCollapseSub: 'Collapse sub-tasks',
  ...
  mdArchivedSection: 'Archived projects',
  archiveProject: 'Archive',
  unarchiveProject: 'Unarchive',
  archiveTitle: 'Archive',
  archiveEmpty: 'No archived projects yet.',
  backToBoard: 'Back to board',
  openArchive: 'Open archive',
  closeArchive: 'Back to board',
  toastArchived: 'Archived',
  toastUnarchived: 'Restored to board',
